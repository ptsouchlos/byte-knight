...
#[rustfmt::skip]
tunable_params!(
    lmp_max_depth           = 6, 6, 10, 1,           true;
    lmp_base                = 6, 1, 10, 1,           true;
    lmp_improvement_min     = -100, -300, 0, 25,     true;
    lmp_improvement_max     = 200, 0, 500, 25,       true;
    lmp_improvement_divisor = 16, 8, 128, 4,         true;
    see_value_pawn          = 100, 50, 150, 1,       true;
    see_value_knight        = 200, 180, 300, 1,      true;
    see_value_bishop        = 300, 250, 250, 1,      true;
    see_value_rook          = 500, 400, 600, 1,      true;
    see_value_queen         = 900, 800, 1100, 1,     true;
    qs_see_threshold        = -100, -100, 100, 1,    true;
    qs_delta_margin         = 200, 50, 300, 1,       true;
    see_tacticals_max_depth = 6, 4, 10, 1,           true;
    see_tacticals_margin    = 50, 0, 100, 1,         true;
    fp_base                 = 100, 50, 150, 1,       true;
    fp_scale                = 80, 40, 120, 1,        true;
    fp_max_depth            = 3, 1, 8, 1,            true;
    rfp_max_depth           = 4, 1, 10, 1,           true;
    rfp_margin              = 82, 40, 120, 1,        true;
    rfp_improving_margin    = 30, 10, 70, 1,         true;
    nmp_min_depth           = 3, 1, 8, 1,            true;
    nmp_depth_reduction     = 2, 0, 6, 1,            true;
    nmp_improving_bonus     = 1, 0, 4, 1,            true;
