...
tunable_params!(
    ...
    lmp_improvement_min     = -111, -300, 0, 25,     true;
    lmp_improvement_max     = 204, 1, 500, 25,       true;
    lmp_improvement_divisor = 11, 2, 128, 4,         true;
    see_value_pawn          = 90, 25, 150, 1,        true;
    see_value_knight        = 188, 100, 300, 1,      true;
    see_value_bishop        = 274, 150, 450, 1,      true;
    see_value_rook          = 450, 250, 750, 1,      true;
    see_value_queen         = 803, 450, 1350, 1,     true;
    qs_see_threshold        = -92, -200, 200, 1,     true;
    qs_delta_margin         = 280, 50, 350, 1,       true;
    see_tacticals_max_depth = 6, 4, 10, 1,           false;
    see_tacticals_margin    = 70, 0, 100, 1,         true;
    fp_base                 = 96, 50, 150, 1,        true;
    fp_scale                = 73, 40, 120, 1,        true;
    fp_max_depth            = 3, 1, 8, 1,            false;
    rfp_max_depth           = 4, 1, 10, 1,           false;
    rfp_margin              = 75, 40, 120, 1,        true;
    rfp_improving_margin    = 31, 10, 70, 1,         true;
    ...
    razoring_scaling        = 262, 100, 800, 10,     true;
    razoring_offset         = 575, 250, 1000, 10,    true;
